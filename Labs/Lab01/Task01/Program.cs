...
class Program
{
    static void Main()
    {
        ...
        // Виведення даних для кожної програми
        Console.WriteLine("| {0,-17} | {1,21} | {2,22:F2} | {3,18:F2} |", name1, code1, time1_sgi1, time1_sgi2);
        Console.WriteLine("| {0,-17} | {1,21} | {2,22:F2} | {3,18:F2} |", name2, code2, time1_sgi1, time1_sgi2);
        Console.WriteLine("| {0,-17} | {1,21} | {2,22:F2} | {3,18:F2} |", name3, code3, time1_sgi1, time1_sgi2);

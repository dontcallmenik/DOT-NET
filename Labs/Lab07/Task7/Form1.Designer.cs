namespace MouseEventsApp
{
    partial class Form1
    {
        ...
        /// Очищення ресурсів
        /// </summary>
        /// <param name="disposing">true, якщо керовані ресурси слід утилізувати</param>
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.MouseDown += new MouseEventHandler(Label_MouseDown);
            this.label1.MouseUp += new MouseEventHandler(Label_MouseUp);
            ...
            this.label2.MouseDown += new MouseEventHandler(Label_MouseDown);
            this.label2.MouseUp += new MouseEventHandler(Label_MouseUp);
            ...
            this.label3.MouseDown += new MouseEventHandler(Label_MouseDown);
            this.label3.MouseUp += new MouseEventHandler(Label_MouseUp);
